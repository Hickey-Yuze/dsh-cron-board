...
export function Badge(props: { children?: ReactNode; tone?: 'default' | 'ok' | 'warn' | 'err' | 'accent'; title?: string }): ReactElement {
...
export function TextArea(props: { value: string; onChange: (v: string) => void; placeholder?: string; rows?: number }): ReactElement {
...
export function Select(props: { value: string; onChange: (v: string) => void; options: { value: string; label: string }[] }): ReactElement {
  return createElement(
    'select',
    { className: 'dsh-cb-select', value: props.value, onChange: (e: { target: { value: string } }) => props.onChange(e.target.value) },
